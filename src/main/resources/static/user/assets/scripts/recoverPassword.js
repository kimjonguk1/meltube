...
$recoverForm.onsubmit = (e) => {
    ...
    xhr.onreadystatechange = () => {
        ...
        const [title, content, onclick] = {
            failure:['비밀번호 재설정', `비밀번호를 재설정 할 수 없습니다. 링크가 올바르지 않거나 링크가 손상되었을 수 있습니다 <br><br>동일한 문제가 반복된다면 비밀번호 재설정 링크를 다시 생성해주세요`, ($dialog)=> Dialog.show($dialog)],
            failure_expired:['비밀번호 재설정', '비밀번호를 재생성할 수 없습니다. 해당 링크는 더 이상 유효하지 않습니다. 멜튜브에서 인증 링크를 다시 받을 수 있습니다'],
